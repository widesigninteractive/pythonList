...
def home(request):
    ...
    if request.method=="GET":
        ...
        #her return the output in to home.html myApp is folder in templates
...
def EmployeeCheck(request):
    #her str declering as global vareble we can use any wher in the function
    global str
    #her c declering as global vareble we can use any wher in the function
    global c
    #c is vareble
    c = 0
    ...
    #Her strlist is main part of code post data from input cath the data through the post method and it convert into str in the from of string
    strlist = str(request.POST["python1"])
    #her i am calling Employeedata calss from models.py and assigning class to Data1
    Data1 = Employeedata()
    #Her I am assigning string type of "sri rama" to the class object of Data.name
    Data1.name = "Sri Rama"
    #Her I am assigning string type of "20220314001" to the class object of Data.name
    Data1.empid = "20220314001"

    #her i am calling Employeedata calss from models.py and assigning class to Data2
    Data2 = Employeedata()
    #Her I am assigning string type of "sri Vishnua" to the class object of Data.name
    Data2.name = "Sri Vishnua"
    #Her I am assigning string type of "20220314002" to the class object of Data.name
    Data2.empid = "20220314002"

    #her i am calling Employeedata calss from models.py and assigning class to Data3
    Data3 = Employeedata()
    #Her I am assigning string type of "sri Hari" to the class object of Data.name
    Data3.name = "Sri Hari"
    #Her I am assigning string type of "20220314003" to the class object of Data.name
    Data3.empid = "20220314003"

    #her i am calling Employeedata calss from models.py and assigning class to Data4
    Data4 = Employeedata()
    #Her I am assigning string type of "Srivalli" to the class object of Data.name
    Data4.name = "Srivalli "
    #Her I am assigning string type of "20220314004" to the class object of Data.name
    Data4.empid = "20220314004"

    #her i am calling Employeedata calss from models.py and assigning class to Data5
    Data5 = Employeedata()
    #Her I am assigning string type of "sri Lakshmi" to the class object of Data.name
    Data5.name = "Sri Lakshmi"
    #Her I am assigning string type of "20220314005" to the class object of Data.name
    Data5.empid = "20220314005"

    #her i am calling Employeedata calss from models.py and assigning class to Data0
    Data00 = Employeedata()
    #Her I am assigning string type of "non" to the class object of Data.name
    Data00.name = "non"
    #Her I am assigning string type of "non" to the class object of Data.name
    Data00.empid = "non"
    ...
    if strlist == "20220314001":
        #her if condetion is satesfive the condetion c will store the 1
        c=1
        # Data1 is assigning to the db and if condetion satisfives the db will print in frentend
        db = Data1
    #Her strlist is cheeking python list of pylist
    elif strlist == "20220314002":
        #her elif condetion is satesfive the condetion c will store the 1
        c=1
    ...
    #Her if c==1 any of above functions c==1 then only sm is print in the frentend part
    if c==1:
        sm="Document Code verification successful provide Issued To" + db.name+" "+db.empid +"For any details please reach out to hr@widesigninc.com"
    #Her c!=1 else db = Data00 will print
    else:
        # Data00 is assigning to the db and if condetion satisfives the db will print in frentend
        db = Data00
        sm="not successful Please reach out to hr@widesigninc.com for additional details"+db.name+ " "+db.empid
    #her return the output in to home.html myApp is folder in templates
